    ...
    <section className="py-[120px] bg-white">
      <div className="max-w-[1200px] mx-auto px-8">
        <div className="mb-16 text-center">
          ...
          <h2 className="text-3xl font-bold text-dark tracking-tight">신뢰로 함께하는 파트너</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {PARTNERS.map((partner, idx) => (
            ...
            >
              <span className="text-muted font-bold tracking-tighter text-xl group-hover:text-dark transition-colors">
                {partner}
              </span>
            </div>
          ))}

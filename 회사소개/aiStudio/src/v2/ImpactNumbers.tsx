...
export default function ImpactNumbers() {
  ...
  return (
    <section ref={sectionRef} className="py-[120px] bg-bg-card">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          {STATS.map((stat, idx) => (
            <div key={idx} className="text-center lg:text-left border-l-0 lg:border-l border-border lg:pl-8 first:border-0">
              ...
              <div className="text-4xl lg:text-6xl font-bold text-text-dark tracking-tighter flex items-baseline justify-center lg:justify-start">

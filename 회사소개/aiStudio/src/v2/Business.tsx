...
const BusinessCard: React.FC<BusinessCardProps> = ({ area, idx }) => {
  return (
    <div 
      className="group cursor-pointer p-8 rounded-[2.5rem] transition-all duration-500 hover:bg-bg-main hover:shadow-2xl hover:shadow-primary/5"
    >
      ...
      <h3 className="text-2xl font-bold text-text-dark mb-4 group-hover:text-accent transition-colors">{area.title}</h3>
...
export default function Business() {
  return (
    <section id="business" className="py-[120px] bg-bg-card">
      <div className="max-w-[1200px] mx-auto px-8">
        <div className="mb-20 text-center">
          <span className="text-accent text-[11px] font-bold tracking-widest uppercase mb-4 block">Business Areas</span>
          <h2 className="text-4xl lg:text-5xl font-bold text-text-dark tracking-tight">사업 영역</h2>
        </div>

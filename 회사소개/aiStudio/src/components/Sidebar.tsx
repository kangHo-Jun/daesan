...
export default function Sidebar() {
  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-[220px] bg-white border-r border-border z-50 hidden lg:flex flex-col p-8">
      <div className="mb-12">
        <h1 className="text-2xl font-bold text-dark tracking-tighter">DAESAN</h1>
        <p className="text-[10px] uppercase tracking-widest text-muted mt-1">Architecture Studio</p>
      </div>
          ...
          <li key={item.id}>
            <button
              ...
              className={cn(
                ...
                activeSection === item.id ? "text-accent translate-x-2" : "text-muted"
              )}
            >
